...
const SEOPages: ISEOPages = {
  ...
  [EPages.CASE_STUDY]: {
    ...
    description:
      'Discover how our solution empowers entrepreneurs to launch and scale their business. Explore how Spartan streamline the journey from idea to market and expertise needed to turn your vision into a successful business in our detailed case study.',
    keywords:
