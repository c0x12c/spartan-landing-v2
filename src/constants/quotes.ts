...
export const quotes = [
  ...
  },
  {
    ...
    text: 'Embarking on my journey with Spartan, I can undoubtedly affirm that this isn’t merely a job for me—it’s a passion that continually fuels my personal and professional growth. Working at Spartan has allowed me to tap into an enriching reservoir of experiences that equip me with diverse skills and enhance my adaptability in dynamic environments. The amalgamation of technology, innovation, and problem-solving here aligns perfectly with my fervor for continual learning. <br/> However, what truly sets this experience apart is the team. Collaborating with such talented, driven individuals is nothing short of inspirational. They encourage me to push my boundaries, fostering mutual respect and shared learning. I’m happy to be a part of the Spartans. ',
    author: 'Ihor Mysak',
